...
class PaymentVerificationLookupResponseModel extends Equatable {
  /// Default constructor for [PaymentVerificationLookupResponseModel].
  const PaymentVerificationLookupResponseModel({
    required this.pidx,
  ...
  /// Factory to create [PaymentVerificationLookupResponseModel] instance from [map].
  factory PaymentVerificationLookupResponseModel.fromJson(
    Map<String, dynamic> map,
  ) {
    return PaymentVerificationLookupResponseModel(
